...
// Float
$section_template_class = 'wp-booking-calendar-mb';
...
if(isset($metadata[$key."_calendar_align"][0]) && $metadata[$key."_calendar_align"][0] == "left" || $metadata[$key."_calendar_align"][0] == "right"){
	$class_one = 'float-content col-sm-6';
	$class_two = 'float-cal col-sm-6';
...
if ($show == 1) {
	echo '<div class="row">';
		...
		if(isset($heading) && $heading){
			echo '<h2 class="wp-booking-cal-title">'.sanitize_text_field($heading_text).'</h2>';
		}
